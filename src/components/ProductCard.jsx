...
const ProductCard = ({prd}) => {
  return (
    <div className='w-1/5 h-[350px] border rounded-lg m-2 flex flex-col items-center p-1 space-y-3'>
      ...
      <div className='text-center opacity-70 text-sm'>{prd?.decription}</div>
